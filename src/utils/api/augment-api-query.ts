...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    iotAuth: {
      caPublicKey: AugmentedQuery<ApiType, () => Observable<U8aFixed>, []> & QueryableStorageEntry<ApiType, []>;
      iotDeviceCount: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      iotDeviceMap: AugmentedQuery<ApiType, (arg: U8aFixed | string | Uint8Array) => Observable<Option<IotAuthIotDevice>>, [U8aFixed]> & QueryableStorageEntry<ApiType, [U8aFixed]>;
      ownerOfCollectibles: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Vec<U8aFixed>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    spambot: {
       ...
       * The sent pings.
       **/
      pings: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * The target parachains to ping.
       **/
      targets: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, Bytes]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
