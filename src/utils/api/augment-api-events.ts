...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    iotAuth: {
      CAPublicKeyUpdated: AugmentedEvent<ApiType, [publicKey: U8aFixed], { publicKey: U8aFixed }>;
      /**
       * A new collectible was successfully created.
       **/
      DeviceCreated: AugmentedEvent<ApiType, [collectible: U8aFixed, owner: AccountId32], { collectible: U8aFixed, owner: AccountId32 }>;
      LocalAuthCredentialIssued: AugmentedEvent<ApiType, [credential: Bytes, signature: U8aFixed], { credential: Bytes, signature: U8aFixed }>;
      LocalAuthFailed: AugmentedEvent<ApiType, [account: AccountId32, random: u64], { account: AccountId32, random: u64 }>;
      LocalAuthSuccess: AugmentedEvent<ApiType, [account: AccountId32, uniqueId: U8aFixed, random: u64], { account: AccountId32, uniqueId: U8aFixed, random: u64 }>;
      ParaAuthCredentialIssued: AugmentedEvent<ApiType, [credential: Bytes, signature: U8aFixed, paraSource: u32, paraRemote: u32], { credential: Bytes, signature: U8aFixed, paraSource: u32, paraRemote: u32 }>;
      ParaAuthFailed: AugmentedEvent<ApiType, [account: AccountId32, paraSource: u32, random: u64], { account: AccountId32, paraSource: u32, random: u64 }>;
      ParaAuthSuccess: AugmentedEvent<ApiType, [account: AccountId32, uniqueId: U8aFixed, paraSource: u32, paraRemote: u32, random: u64], { account: AccountId32, uniqueId: U8aFixed, paraSource: u32, paraRemote: u32, random: u64 }>;
      TestMessage: AugmentedEvent<ApiType, [message: u32], { message: u32 }>;
      TestResponse: AugmentedEvent<ApiType, [uniqueId: U8aFixed, account: AccountId32], { uniqueId: U8aFixed, account: AccountId32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    spambot: {
      ErrorSendingPing: AugmentedEvent<ApiType, [XcmV2TraitsSendError, u32, u32, Bytes]>;
      ErrorSendingPong: AugmentedEvent<ApiType, [XcmV2TraitsSendError, u32, u32, Bytes]>;
      Pinged: AugmentedEvent<ApiType, [u32, u32, Bytes]>;
      PingSent: AugmentedEvent<ApiType, [u32, u32, Bytes]>;
      Ponged: AugmentedEvent<ApiType, [u32, u32, Bytes, u32]>;
      PongSent: AugmentedEvent<ApiType, [u32, u32, Bytes]>;
      UnknownPong: AugmentedEvent<ApiType, [u32, u32, Bytes]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
