...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    iotAuth: {
       ...
       **/
      BoundsOverflow: AugmentedError<ApiType>;
      /**
       * The device description is too long
       **/
      DescriptionTooLong: AugmentedError<ApiType>;
      /**
       * Each description must have a unique identifier
       **/
      DuplicateDevices: AugmentedError<ApiType>;
      /**
       * An account can't exceed the `MaximumOwned` constant
       **/
      MaximumDevicesOwned: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
      [key: string]: AugmentedError<ApiType>;
